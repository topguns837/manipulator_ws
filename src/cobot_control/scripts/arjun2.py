...
def main():
  ...
  try:
    ...
    ur5.go_to_joint_state(ur5.pick_down[0] - ur5.rotate_iters*0.04 , ur5.pick_down[1] , ur5.pick_down[2], ur5.pick_down[3] , ur5.pick_down[4]  ,ur5.pick_down[5])

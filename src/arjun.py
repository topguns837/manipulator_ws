...
def main():
  ...
  try:
    ...
    ur5.go_to_joint_state(ur5.pick_down[0] - ur5.rotate_iters*0.1*ur5.rotate_dir , ur5.pick_down[1] + 23 , ur5.pick_down[2] - 23, ur5.pick_down[3] , ur5.pick_down[4]  ,ur5.pick_down[5])
    #print("Pick Down")
    time.sleep(5)
